...
file write fh "& \multicolumn{5}{c}{Dependent variable: 10th grade `var_name'} \\"
file write fh "& \multicolumn{5}{c}{Number of Nearest Neighbors} \\"
file write fh "Treatment & NN=1 & NN=2 & NN=3 & NN=4 & NN=5 \\" _n
