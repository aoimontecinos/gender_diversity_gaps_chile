...
esttab m* using "$tables/Table_A3.tex", ///
...
"$tables/Table_A4.tex",  keep($genders *agg* discr*) ///
...
esttab using "$tables/Table_A5.tex", ///
...
esttab using "$tables/Table_A6.tex", ///
b(3) se(3) nodepvar star(* 0.1 ** 0.05 *** 0.01) booktabs nonotes ///
...
esttab m1 m2 m3 m4 using "$tables/Table_2.tex", ///
